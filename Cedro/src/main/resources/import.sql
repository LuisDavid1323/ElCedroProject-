...
/*Diseno*/
INSERT INTO `Diseños`(`Nombre_d`) VALUES ('Clásico');
INSERT INTO `Diseños`(`Nombre_d`) VALUES ('Moderno');
INSERT INTO `Diseños`(`Nombre_d`) VALUES ('Deko');
INSERT INTO `Diseños`(`Nombre_d`) VALUES ('Rustico');
