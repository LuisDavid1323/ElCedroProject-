...
public class OrdenProduccion  implements Serializable{
	...
	private EstadoOrdenProduccionEnum EstadoOrdenP;
	...
	public EstadoOrdenProduccionEnum getEstadoOrdenP() {
		return EstadoOrdenP;
	}

	public void setEstadoOrdenP(EstadoOrdenProduccionEnum estadoOrdenP) {
