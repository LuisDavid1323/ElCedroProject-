...
public class Salida implements Serializable{
	...
	private orden_de_produccion id_orden_pro_fk;
	...
	public orden_de_produccion getId_orden_pro_fk() {
		return id_orden_pro_fk;
	}

	public void setId_orden_pro_fk(orden_de_produccion id_orden_pro_fk) {
